...
import { useDegrees, useEmploymentStatuses, useReasonsForLeaving } from '@/features/employee/history/hooks/useQueries';
import { useStore } from '@/features/employee/history/hooks/useStore';
import { defaultValues, ReasonForLeavingEnum, schema, Schema } from '@/features/employee/history/types/schema';
...
const Page = () => {
  ...
  return (
    <>
      ...
      <Grid size={{ xs: 6 }}>
        {reasonsForLeavingPreviousJobs.includes(ReasonForLeavingEnum.enum.OTHER) && (
          <TextField<Schema>
