import { getDegrees, getEmploymentStatuses, getReasonsForLeaving } from '@/features/employee/history/utils/api';
...
export { useDegrees, useEmploymentStatuses, useReasonsForLeaving };
