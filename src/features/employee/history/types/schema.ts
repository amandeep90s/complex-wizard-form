...
const schema = z
  ...
  .superRefine((data, ctx) => {
    const hasOtherReasonsForLeavingPreviousJobs = data.reasonsForLeavingPreviousJobs.includes(
...
export { defaultValues, schema as employeeHistorySchema, ReasonForLeavingEnum, schema, type Schema };
